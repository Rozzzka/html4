...
<body>
    <div class="logo">
        <a href="<?php echo e(route('login')); ?>">
            <img src="<?php echo e(asset('images/Untitled42_20240520114859.png')); ?>" alt="Logo">
        </a>
    </div>
    <div class="login-container">
        ...
        <form>
            ...
            <button type="submit" class="btn btn-custom btn-block" formaction="<?php echo e(route('home')); ?>">Log In</button>
        </form>
        <div class="signup-link">
            <p>Don't have an account? <span><a href="<?php echo e(route('registration')); ?>"><u>Sign up</u></a></span></p>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\html3\resources\views/login.blade.php ENDPATH**/ ?>